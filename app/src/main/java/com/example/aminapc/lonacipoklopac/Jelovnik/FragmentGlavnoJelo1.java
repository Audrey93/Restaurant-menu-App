...
public class FragmentGlavnoJelo1 extends Fragment {

    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_glavnojelo1_layout, container, false);
        TextView txt = (TextView) v.findViewById(R.id.glavnojelo1);
