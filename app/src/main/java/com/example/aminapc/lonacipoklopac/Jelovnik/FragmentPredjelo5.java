...
public class FragmentPredjelo5 extends Fragment {

    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_predjelo5_layout, container, false);
        TextView txt = (TextView) v.findViewById(R.id.predjelo5);
