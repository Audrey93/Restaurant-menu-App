...
public class FragmentGlavnoJelo5 extends Fragment {

    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_glavnojelo5_layout, container, false);
        TextView txt = (TextView) v.findViewById(R.id.glavnojelo5);
